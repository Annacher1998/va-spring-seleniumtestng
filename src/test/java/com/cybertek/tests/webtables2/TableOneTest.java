...
List<WebElement> rowCount=driver.findElements(By.xpath("//table[@id='table1']//tr"));
        System.out.println("Number of row : "+rowCount.size());
    ...
    public int getColCount() {
        ...
        System.out.println("Number of columns: "+colCount.size());
    ...
    public int[] getTableSize() {
        ...
        int colomn=getColCount();

tableSize=new int[]{rows,colomn};
        System.out.println("Column: "+colomn+" Rows: "+rows);
        return tableSize;
    }
    @Test
    ...
    public List<WebElement> getHeaders() {
        ...
        headers.forEach(names-> System.out.println(names.getText()));
    ...
    public List<WebElement> getCellsInColumn(String colName) {
        ...
        //TODO another way to find getCellInColumn
//       int idx=0;
//        List<WebElement> headers = getHeaders();
//        for (int i = 0; i < headers.size(); i ++){
//            String temp = headers.get(i).getText();
//            if(temp.equals(colName)){
//                idx = i+1;
//            }
//        }
//        List<WebElement> result = driver.findElements
//                (By.xpath("//table[@id='table1']/tbody/tr/td["+idx+"]"));
//        return result;

        List<WebElement> headers=getHeaders();
        List<String> stringHeadres=BrowserUtils.getElementsText(headers);
        int index=stringHeadres.indexOf(colName)+1;
        List<WebElement> result=driver.findElements(By.xpath("//table[@id='table1']/tbody/tr/td["+index+"]"));
        return result;
